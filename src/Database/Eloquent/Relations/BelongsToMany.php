...
use SoftTent\WpEloquent\Database\Eloquent\ModelNotFoundException;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @param  \SoftTent\WpEloquent\Database\Eloquent\Builder|null  $query
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \SoftTent\WpEloquent\Support\Collection|\SoftTent\WpEloquent\Database\Eloquent\Model
     */
     ...
     * @return \SoftTent\WpEloquent\Database\Eloquent\Model
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \SoftTent\WpEloquent\Database\Eloquent\Model|\SoftTent\WpEloquent\Database\Eloquent\Collection|null
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \SoftTent\WpEloquent\Database\Eloquent\Model|\SoftTent\WpEloquent\Database\Eloquent\Collection
     *
    ...
    public function paginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return asdb_tap($this->query->paginate($perPage, $columns, $pageName, $page), function ($paginator) {
    ...
    public function simplePaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        ...
        return asdb_tap($this->query->simplePaginate($perPage, $columns, $pageName, $page), function ($paginator) {
            $this->hydratePivotRelation($paginator->items());
        });
    }
    ...
    {
        return Str::camel(Str::pluralStudly(asdb_class_basename($this->getParent())));
    }
     ...
     *
     * @param  \SoftTent\WpEloquent\Support\Collection|array  $models
     * @param  array  $pivotAttributes
     * @return array
     */
