...
use SoftTent\WpEloquent\Database\Schema\Grammars\Grammar;
use SoftTent\WpEloquent\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \SoftTent\WpEloquent\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \SoftTent\WpEloquent\Support\Fluent[]
     */
    protected $commands = [];
    ...
    {
        return asdb_collect($this->commands)->filter(function ($command) use ($names) {
    ...
    {
        return asdb_collect($this->commands)->contains(function ($command) {
     ...
     *
     * @return \SoftTent\WpEloquent\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \SoftTent\WpEloquent\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \SoftTent\WpEloquent\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \SoftTent\WpEloquent\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \SoftTent\WpEloquent\Database\Eloquent\Model|string  $model
    ...
    {
        return ! is_null(asdb_collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return asdb_collect($this->getAddedColumns())->mapWithKeys(function ($column) {
            return $column->autoIncrement === true
