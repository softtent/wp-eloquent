...
use SoftTent\WpEloquent\Database\MySqlConnection;
use SoftTent\WpEloquent\Database\PostgresConnection;
use SoftTent\WpEloquent\Database\SQLiteConnection;
use SoftTent\WpEloquent\Database\SqlServerConnection;
use SoftTent\WpEloquent\Database\WpConnection;
...
class ConnectionFactory
{
     ...
     *
     * @param  array  $config
     * @return \SoftTent\WpEloquent\Database\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
