...
namespace SoftTent\WpEloquent;

use SoftTent\WpEloquent\Events\Dispatcher;
use SoftTent\WpEloquent\Database\Capsule\Manager;
use SoftTent\WpEloquent\Database\WpConnection;
use SoftTent\WpEloquent\Support\Facades\Facade;
